...
/**
 * Class GreaterThanOrEqualPropertyValueValidator
 *
 * @package AppBundle\Validator\Constraints
 *
 * Check current property value greater than of value of property that name indicates in parameter
 */
class GreaterThanOrEqualPropertyValueValidator extends ConstraintValidator
{
    /**
     * @param mixed $value
    ...
    {
        if (!$constraint instanceof GreaterThenOrEqualPropertyValue) {
            throw new UnexpectedTypeException($constraint, GreaterThenOrEqualPropertyValue::class);
        }
